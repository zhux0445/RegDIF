...
\begin{equation}
\begin{aligned}
E[log\lbrace L(\textbf A,\textbf D, \boldsymbol \beta, \boldsymbol \mu, \boldsymbol \Sigma \mid \textbf Y, \textbf U, \boldsymbol \Theta)] &= \sum_y^3 \sum_g^G \sum_j^m \sum_k^p  (r_{jgky}  \mathrm{log} P_{jky\mid q_{g}})+ \sum_y^3 \sum_g^G n_{gy} \mathrm{log} f(\boldsymbol \mu_y, \boldsymbol \Sigma_y \mid\boldsymbol q_{g} ) 
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\log M_j &= \sum_y^3 \sum_g^G \sum_k^p  (r_{jgky}  \mathrm{log} P_{jky\mid q_{g}})+ \sum_y^3 \sum_g^G n_{gy} \mathrm{log} f(\boldsymbol \mu_y, \boldsymbol \Sigma_y \mid\boldsymbol q_{g}) 
\end{aligned}
\end{equation}
