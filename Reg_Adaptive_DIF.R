...
##################################################
Reg_Adaptive_DIF <- function(resp,eta,lam=1,eps =1e-3,max.tol=1e-7,r,y,N.vec=N.vec,gra00,grd00,grbeta00,grgamma00,Mu.list,Sig.list)
{
  if (min(resp)==0){
