...
for (rep in 1:reps){
  a1=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma5_",rep),row.names = 1)[c(2,3,10,11),1]
  a2=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma5_",rep),row.names = 1)[c(2,3,10,11),2]
  absbias1[rep]=mean(abs(a1[which(a1!=0)]+0.4))
  absbias2[rep]=mean(abs(a2[which(a2!=0)]+0.6))
}
mean(na.omit(absbias1))
mean(na.omit(absbias2))
sd(na.omit(absbias1))/sqrt(length(na.omit(absbias1)))
sd(na.omit(absbias2))/sqrt(length(na.omit(absbias2)))
...
for (rep in 1:reps){
  a3=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NABeta5_",rep),row.names = 1)[c(4:5,12:13),1]
  a4=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NABeta5_",rep),row.names = 1)[c(4:5,12:13),2]
  absbias3[rep]=mean(abs(a3[which(a3!=0)]-0.25))
  absbias4[rep]=mean(abs(a4[which(a4!=0)]-0.6))
}
mean(na.omit(absbias3))
mean(na.omit(absbias4))
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))
...
absbias2=numeric(50)
for (rep in 1:reps){
  a1=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma6_",rep),row.names = 1)[c(2:7,10:15),1]
  a2=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma6_",rep),row.names = 1)[c(2:7,10:15),2]
  absbias1[rep]=mean(abs(a1[which(a1!=0)]+0.4))
  absbias2[rep]=mean(abs(a2[which(a2!=0)]+0.6))
}
mean(na.omit(absbias1))
...
absbias2=numeric(50)
for (rep in 1:5){
  a1=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma7_",rep),row.names = 1)[c(2:3,10:11),1]
  a2=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma7_",rep),row.names = 1)[c(2:3,10:11),2]
  absbias1[rep]=mean(abs(a1[which(a1!=0)]+0.4))
  absbias2[rep]=mean(abs(a2[which(a2!=0)]+0.6))
}
for (rep in 6:reps){
...
absbias2=numeric(50)
for (rep in 1:reps){
  a1=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma5lowcor_",rep),row.names = 1)[c(4:9,12:17),1]
  a2=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma5lowcor_",rep),row.names = 1)[c(4:9,12:17),2]
  absbias1[rep]=mean(abs(a1[which(a1!=0)]+0.4))
  absbias2[rep]=mean(abs(a2[which(a2!=0)]+0.6))
}
mean(na.omit(absbias1))
...
absbias4=numeric(50)
for (rep in 1:reps){
  a3=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NABeta5lowcor_",rep),row.names = 1)[c(4:9,12:17),1]
  a4=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NABeta5lowcor_",rep),row.names = 1)[c(4:9,12:17),2]
  absbias3[rep]=mean(abs(a3[which(a3!=0)]-0.25))
  absbias4[rep]=mean(abs(a4[which(a4!=0)]-0.6))
}
mean(na.omit(absbias3))
...
absbias2=numeric(50)
for (rep in 1:reps){
  a1=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma5EMMlowcor_",rep),row.names = 1)[c(4:9,12:17),1]
  a2=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma5EMMlowcor_",rep),row.names = 1)[c(4:9,12:17),2]
  absbias1[rep]=mean(abs(a1[which(a1!=0)]+0.4))
  absbias2[rep]=mean(abs(a2[which(a2!=0)]+0.6))
}
mean(na.omit(absbias1))
...
absbias4=numeric(50)
for (rep in 1:reps){
  a3=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NABeta5EMMlowcor_",rep),row.names = 1)[c(4:9,12:17),1]
  a4=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NABeta5EMMlowcor_",rep),row.names = 1)[c(4:9,12:17),2]
  absbias3[rep]=mean(abs(a3[which(a3!=0)]-0.25))
  absbias4[rep]=mean(abs(a4[which(a4!=0)]-0.6))
}
mean(na.omit(absbias3))
...
absbias2=numeric(50)
for (rep in 1:reps){
  a1=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma5Adaptlowcor_",rep),row.names = 1)[c(4:9,12:17),1]
  a2=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NAGamma5Adaptlowcor_",rep),row.names = 1)[c(4:9,12:17),2]
  absbias1[rep]=mean(abs(a1[which(a1!=0)]+0.4))
  absbias2[rep]=mean(abs(a2[which(a2!=0)]+0.6))
}
mean(na.omit(absbias1))
...
absbias4=numeric(50)
for (rep in 1:reps){
  a3=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NABeta5Adaptlowcor_",rep),row.names = 1)[c(4:9,12:17),1]
  a4=read.csv(paste("/Users/zhux0445/Documents/Github/RegDIF_SimData/NABeta5Adaptlowcor_",rep),row.names = 1)[c(4:9,12:17),2]
  absbias3[rep]=mean(abs(a3[which(a3!=0)]-0.25))
  absbias4[rep]=mean(abs(a4[which(a4!=0)]-0.6))
}
mean(na.omit(absbias3))
...
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))
absbias1=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec52.csv")[,3]
sd(na.omit(absbias1))/sqrt(length(na.omit(absbias1)))
absbias2=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec53.csv")[,3]
sd(na.omit(absbias2))/sqrt(length(na.omit(absbias2)))
absbias3=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec52.csv")[,3]
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
absbias4=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec53.csv")[,4]
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))

absbias1=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec62.csv")[,3]
sd(na.omit(absbias1))/sqrt(length(na.omit(absbias1)))
absbias2=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec63.csv")[,3]
sd(na.omit(absbias2))/sqrt(length(na.omit(absbias2)))
absbias3=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec62.csv")[,3]
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
absbias4=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec63.csv")[,4]
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))

absbias1=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec72.csv")[,3]
sd(na.omit(absbias1))/sqrt(length(na.omit(absbias1)))
absbias2=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec73.csv")[,3]
sd(na.omit(absbias2))/sqrt(length(na.omit(absbias2)))
absbias3=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec72.csv")[,3]
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
absbias4=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec73.csv")[,4]
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))

absbias1=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec82.csv")[,3]
sd(na.omit(absbias1))/sqrt(length(na.omit(absbias1)))
absbias2=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec83.csv")[,3]
sd(na.omit(absbias2))/sqrt(length(na.omit(absbias2)))
absbias3=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec82.csv")[,3]
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
absbias4=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec83.csv")[,4]
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))


absbias3=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec52lowcor.csv")[,3]
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
absbias4=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec53lowcor.csv")[,4]
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))

absbias1=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec62lowcor.csv")[,3]
sd(na.omit(absbias1))/sqrt(length(na.omit(absbias1)))
absbias2=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec63lowcor.csv")[,3]
sd(na.omit(absbias2))/sqrt(length(na.omit(absbias2)))
absbias3=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec62lowcor.csv")[,3]
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
absbias4=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec63lowcor.csv")[,4]
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))

absbias1=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec72lowcor.csv")[,3]
sd(na.omit(absbias1))/sqrt(length(na.omit(absbias1)))
absbias2=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec73lowcor.csv")[,3]
sd(na.omit(absbias2))/sqrt(length(na.omit(absbias2)))
absbias3=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec72lowcor.csv")[,3]
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
absbias4=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec73lowcor.csv")[,4]
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))

absbias1=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec82lowcor.csv")[,3]
sd(na.omit(absbias1))/sqrt(length(na.omit(absbias1)))
absbias2=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifArec83lowcor.csv")[,3]
sd(na.omit(absbias2))/sqrt(length(na.omit(absbias2)))
absbias3=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec82lowcor.csv")[,3]
sd(na.omit(absbias3))/sqrt(length(na.omit(absbias3)))
absbias4=read.csv("/Users/zhux0445/Documents/Github/RegDIF_SimData/NALRTNonUnifrec83lowcor.csv")[,4]
sd(na.omit(absbias4))/sqrt(length(na.omit(absbias4)))
