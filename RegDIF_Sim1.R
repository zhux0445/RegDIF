...
write.csv(mirt.p.mat1,file = "Sim1lowcor_LRTpvs1.csv")
write.csv(mirt.p.mat2,file = "Sim1lowcor_LRTpvs2.csv")
write.csv(mirt.p.mat3,file = "Sim1lowcor_LRTpvs3.csv")
write.csv(bias.mirt1,file = "Sim1lowcor_LRTbias1.csv")
write.csv(bias.mirt2,file = "Sim1lowcor_LRTbias2.csv")
write.csv(bias.mirt3,file = "Sim1lowcor_LRTbias3.csv")
write.csv(rmse.mirt1,file = "Sim1lowcor_LRTrmse1.csv")
write.csv(rmse.mirt2,file = "Sim1lowcor_LRTrmse2.csv")
write.csv(rmse.mirt3,file = "Sim1lowcor_LRTrmse3.csv")
write.csv(difrec.mirt.fn1,file = "Sim1lowcor_LRTfn1.csv")
write.csv(difrec.mirt.fn2,file = "Sim1lowcor_LRTfn2.csv")
write.csv(difrec.mirt.fn3,file = "Sim1lowcor_LRTfn3.csv")
